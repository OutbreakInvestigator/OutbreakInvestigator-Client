/**
 * Created by detwiler on 4/10/14.
 */
    ...
    .directive('leaflet', function () {
        return {
            ...
            link: function (scope, iElm, iAttrs, controllers) {
                ...
                //var iScope = angular.element(iElm).isolateScope();
                scope.uid = iElm.uniqueId();

                console.log("unique element id = "+scope.uid);
                /*
                $timeout(function() {
                    // comment this out to see the original fire as well
                    iElm.off('click');
                    ...
                    iElm.on('click', function (e) {
                        ...
                        scope.$apply(function () {
                            iScope.increment();
                            console.log('click wrapper:', iScope.value);
                        });
                    })
                });
                */
