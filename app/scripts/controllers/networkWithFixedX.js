        ...
        return {
            ...
            link: function (scope, elem, attrs) {
                ...
                function update(newVal) {
                    ...
                    var nodes = graph_data.nodes, links = graph_data.links;//[];//d3.layout.force().links(nodes);
                    ...
                    nodeCircles = vis.selectAll("circle.node")
                        ...
                        .style("fill", color);  //TODO: check this here and in network.js, does it do anything?
                        //.style("fill", "red");
