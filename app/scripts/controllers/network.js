        ...
        return {
            ...
            link: function (scope, elem, attrs) {
                ...
                function showDetails(d) {
                    var baseurl, content;
                    content = '<div><span class="main" >' + d.dbid + '</span><span class="main" style="float:right">' + 'test' + '</span></div>';
                    content += '<hr class="tooltip-hr">';
                    //content += '<div><span class="span-color" style="background-color:' + d.color + '"></span>' + d.values + '</div>';
                    //content += '<div>' + d.short_desc + '</div>';
                ...
                */
                ...
                function updateCaseSelection(elem, inCases)
                {
                    ...
                    //eventService.setSelCase(inCase);
                }
...
//                var curr_graph = graphService.getGraph();
//                if(curr_graph!=null)
//                {
//                    update(curr_graph);
//
